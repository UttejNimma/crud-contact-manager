...
const ChartsAndMaps = () => {
  ...
  return (
    <div className="border-box relative my-20 flex w-full flex-1 flex-col items-center gap-10 px-4 md:px-10 ">
      ...
      {worldWideData && (
        <div className="flex w-full flex-col items-center gap-4 rounded-lg py-5 shadow-lg ">
          <h1 className="text-2xl font-bold capitalize">World-Wide Cases</h1>
